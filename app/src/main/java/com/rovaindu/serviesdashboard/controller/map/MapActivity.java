package com.rovaindu.serviesdashboard.controller.map;
...
import com.rovaindu.serviesdashboard.controller.agents.AgentsActivity;
...
import com.rovaindu.serviesdashboard.utils.map.CurrentPlaceSelectionBottomSheet;
import com.rovaindu.serviesdashboard.utils.map.PermissionUtility;
        ...
        mBtnSelectAddress.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (addresses != null) {
                    ...
                    ServiesAgentSharedPrefManager.getInstance(getApplicationContext()).userLocation(userAddress.getLatitude() + "," + userAddress.getLongitude());
                    ServiesAgentSharedPrefManager.getInstance(getApplicationContext()).setOLocation(userAddress);
