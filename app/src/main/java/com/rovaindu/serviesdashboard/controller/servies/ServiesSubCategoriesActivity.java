package com.rovaindu.serviesdashboard.controller.servies;
...
import com.rovaindu.serviesdashboard.controller.map.MapActivity;
...
import com.rovaindu.serviesdashboard.manager.ServiesBase;
...
import com.rovaindu.serviesdashboard.utils.views.compoundbuttongroup.CompoundButtonGroup;
...
public class ServiesSubCategoriesActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(ServiesAgentSharedPrefManager.getInstance(getApplicationContext()).isCarted()) {
            boolean inserted = ServiesBase.getInstance().AssignOrder(ServiesAgentSharedPrefManager.getInstance(getApplicationContext()).getServices());
        }
        if(category != null)
        {
        ...
        btnProceed.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ServiesBase.getInstance().getmOrders().size() > 0) {
                    ServiesAgentSharedPrefManager.getInstance(getApplicationContext()).setServices(ServiesBase.getInstance().getmOrders());
                    GoogleMap();
                    /*
