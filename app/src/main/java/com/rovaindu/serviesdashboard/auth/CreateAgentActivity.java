...
import com.rovaindu.serviesdashboard.utils.Utilites;
import com.rovaindu.serviesdashboard.utils.map.PlacePicker;
import com.rovaindu.serviesdashboard.utils.views.TextViewAr;
import com.rovaindu.serviesdashboard.utils.views.materialSpinner.MaterialSpinner;
...
public class CreateAgentActivity extends BaseActivity {
                                            ...
                                            if (etPhone.getText().length() == 11) {
                                                ...
                                                if (etPassword.getText().toString().equals(etrePassword.getText().toString())) {
                                                    ...
                                                    if(getPlanID() != -1 & getJobID() != -1 && getServiesID() != -1) {
                                                        Log.d("REG", "onClick: 10");
                                                        if(etIDNumber.getText().length() > 0) {

                                                            Log.d("REG", "onClick: 11");
                                                            if (getPICImage() != null) {
                                                                if (getIDImage() != null) {
                                                                    try {
                                                                        Log.d("REG", "onClick: 12");
                                                                    ...
                                                                    {
                                                                        Log.d("REG", "onClick: " + ex.getLocalizedMessage());
                                                                    }
                                                                }
                                                                else
                                                                {
                        ...
                        public void onResponse(Call<AgentRegisterResponse> call, Response<AgentRegisterResponse> response) {
                            ...
                            if (response.body() != null) {
                                 ...
                                 */
                                     ...
                                     */
                                        Intent loginIntent = new Intent(CreateAgentActivity.this, CreateAgentDetailsAvtivity.class);
                                        loginIntent.putExtra(Constants.BUNDLE_AGENTS_LIST, (Serializable) response.body().getData().getObject());
    ...
    private boolean getRating(String password) throws IllegalArgumentException {
        ...
        {
            Log.d("REG", "getRating: " + ex.getLocalizedMessage());
        }
        return true;
    }
    ...
    private void getMainCategory() {
        ...
        call.enqueue(new Callback<CountryResponse>() {
            ...
            public void onResponse(Call<CountryResponse> call, Response<CountryResponse> response) {
                ...
                ArrayAdapter<String> spinnerMainAdapter = new ArrayAdapter<String>(CreateAgentActivity.this,  android.R.layout.simple_dropdown_item_1line, Values_main);
            ...
            public void onFailure(Call<CountryResponse> call, Throwable t) {
                Toast.makeText(CreateAgentActivity.this, t.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
    ...
    private void getSubCategory(int type) {
        ...
        call.enqueue(new Callback<CityResponse>() {
            ...
            public void onResponse(Call<CityResponse> call, Response<CityResponse> response) {
                ...
                ArrayAdapter<String> spinnerMainAdapter = new ArrayAdapter<String>(CreateAgentActivity.this,  android.R.layout.simple_dropdown_item_1line, Values_sub);
                spinnerMainAdapter.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item); // The drop down view
        ...
        if (requestCode == GALLERYID) {
            if (resultData != null) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(CreateAgentActivity.this, "Failed!", Toast.LENGTH_SHORT).show();
                }
            }
        }
        else
