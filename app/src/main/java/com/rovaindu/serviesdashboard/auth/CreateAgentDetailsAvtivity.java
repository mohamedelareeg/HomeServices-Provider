...
import com.rovaindu.serviesdashboard.retrofit.models.Bank;
...
public class CreateAgentDetailsAvtivity extends BaseActivity {
    @Override
    public void onRequestPermissionsResult(int requestCode,
                                           String permissions[], @NotNull int[] grantResults) {
        switch (requestCode) {
            case 1: {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_agent_details_avtivity);
        ...
        DatePanel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(CreateAgentDetailsAvtivity.this,
                        ...
                        public void onResponse(Call<AgentCompleteRegisterResponse> call, Response<AgentCompleteRegisterResponse> response) {
                            ...
                            if (response.body() != null) {
                                 ...
                                 */
                                    ...
                                    finish();
                                    Toast.makeText(CreateAgentDetailsAvtivity.this, getResources().getText(R.string.register_succ), Toast.LENGTH_SHORT).show();
                                }
    ...
    private void getBank() {
        ...
        call.enqueue(new Callback<BankResponse>() {
            ...
            public void onResponse(Call<BankResponse> call, Response<BankResponse> response) {
                ...
                ArrayAdapter<String> spinnerMainAdapter = new ArrayAdapter<String>(CreateAgentDetailsAvtivity.this,  android.R.layout.simple_dropdown_item_1line, Values_sub);
            ...
            public void onFailure(Call<BankResponse> call, Throwable t) {
                Toast.makeText(CreateAgentDetailsAvtivity.this, t.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
        ...
        if (requestCode == GALLERYPIC) {
            if (resultData != null) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(CreateAgentDetailsAvtivity.this, "Failed!", Toast.LENGTH_SHORT).show();
                }
            }
        }
    }
