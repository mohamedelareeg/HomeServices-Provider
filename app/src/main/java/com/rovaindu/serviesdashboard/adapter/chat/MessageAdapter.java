package com.rovaindu.serviesdashboard.adapter.chat;
...
import com.rovaindu.serviesdashboard.interfaces.chat.StickyHeaderAdapter;
...
import com.rovaindu.serviesdashboard.model.chat.Call;
...
import com.rovaindu.serviesdashboard.utils.ZoomIv;
...
import static com.rovaindu.serviesdashboard.utils.views.chat.Utils.getDate;
import static com.rovaindu.serviesdashboard.utils.views.chat.Utils.getDateId;
import static com.rovaindu.serviesdashboard.utils.views.chat.Utils.getFileSize;
import static com.rovaindu.serviesdashboard.utils.views.chat.Utils.getHeaderDate;
import static com.rovaindu.serviesdashboard.utils.views.chat.Utils.isDarkMode;
import static com.rovaindu.serviesdashboard.utils.views.chat.Utils.removeEmojiAndSymbol;
...
public class MessageAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements StickyHeaderAdapter<MessageAdapter.DateItemHolder> {
    ...
    private ServiesAgent loggedInUser = ServiesAgentSharedPrefManager.getInstance(context).getUser();
...
//
    ...
    private void setColorFilter(BaseMessage baseMessage,View view){
        ...
        {
            if (baseMessage.getSender().equals(ServiesAgentSharedPrefManager.getInstance(context).getUser()))
                view.getBackground().setColorFilter(context.getResources().getColor(R.color.primaryColorYellowBlack), PorterDuff.Mode.SRC_ATOP);
            else
