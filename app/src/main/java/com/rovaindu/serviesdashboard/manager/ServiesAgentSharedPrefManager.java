package com.rovaindu.serviesdashboard.manager;
...
import com.rovaindu.serviesdashboard.retrofit.models.Rate;
...
public class ServiesAgentSharedPrefManager {
    ...
    private static final String SHARED_PREF_NAME = "serviesagentapp";
