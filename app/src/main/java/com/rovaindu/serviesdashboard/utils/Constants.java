...
public class Constants {
    ...
    public static final String BUNDLE_CATEGORIES_LIST = "BUNDLE_CATEGORIES_LIST";
    public static final String BUNDLE_AGENTS_LIST = "BUNDLE_AGENTS_LIST";
    ...
    public static final String BUNDLE_COMPLAIN_LIST = "BUNDLE_COMPLAIN_LIST";
    public static final String BUNDLE_SELECTED_SERVIES_LIST = "BUNDLE_SELECTED_SERVIES_LIST";
    public static final String BUNDLE_CURRENT_ADDRESS = "BUNDLE_CURRENT_ADDRESS";
