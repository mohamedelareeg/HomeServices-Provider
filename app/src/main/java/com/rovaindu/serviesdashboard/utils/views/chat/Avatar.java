...
public class Avatar extends AppCompatImageView {
    ...
    protected void init() {
        ...
        paint.setColor(getResources().getColor(R.color.primaryColorYellowBlack));
        ...
        color = getResources().getColor(R.color.primaryColorYellowBlack);
   ...
   private RectF calculateBounds() {
     ...
     * @see ServiesAgent
     */
    public void setAvatar(@NonNull ServiesAgent user) {
